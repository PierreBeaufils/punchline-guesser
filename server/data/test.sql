...
INSERT INTO "quiz" ("title", "description", "difficulty_id") VALUES
('Facile', 'Lyrics les plus connus du Rap Game', 1),
('Intermédiaire', 'On commence à jouer sérieux', 2),
('Difficile', 'Accroche-toi bien...', 3);

INSERT INTO "quiz" ("title", "description") VALUES
('Mix', 'Toutes les punchlines réunies !');
...
('Poids lourd contre trisomique, à la pesée des kilos, Tu vois flou, gant noir sur automatique au lever du rideau', 2, 3),
('J''écoute tes couplets ta zik, trop des barres... j''apporte des gobelets en plastique pour ton pot de départ.', 1, 3),
('Le monde fait flipper, mec tu sais plus rien ne m’atteint, et plus je connais les hommes plus j’aime mon chien.', 1, 1),
('On joue pas de la mandoline, j''ai le glaive de la garde prétorienne, J''te fume comme à Medellín et j''soulève deux, trois mongoliennes', 2, 3),
